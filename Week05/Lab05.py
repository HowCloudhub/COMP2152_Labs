...
for nums, target in test_cases:
    ...
    print("nums=" + str(nums) + ", target=" +
          str(target) + " -> index: " + str(result))
...
for target in [-1, 0, 3, 5, 9, 12, 2, 100]:
    ...
    print("Target " + str(target).rjust(4) + ": Iterative=" +
          str(iter_result).rjust(2) + ", Recursive=" + str(rec_result).rjust(2) + " " + match)
